# SQLAlchemy ORM Expert - Agent Skill

## For AI Agents

This skill provides comprehensive SQLAlchemy 2.0+ guidance optimized for AI agent consumption. Use this skill when helping users build customer support systems with robust database operations.

### Quick Agent Guide

**When to Load**: User mentions SQLAlchemy, ORM, database models, async sessions, query optimization, or asks about customer support data structures.

**What This Skill Provides**:
- Production-ready code patterns for customer support systems
- Clear response templates for common queries
- Error handling and edge case guidance
- Testing patterns and best practices
- Migration workflows

**Structure**:
- **SKILL.md**: Core patterns and quick reference (lean, ~250 lines)
- **EXAMPLES.md**: 15+ complete, runnable examples (2,700+ lines)
- **references/**: Deep-dive documentation
  - `advanced-patterns.md` - Complex queries, analytics, window functions
  - `error-handling.md` - Comprehensive error patterns
  - `agent-response-patterns.md` - How to respond to different query types

## For Humans

Comprehensive SQLAlchemy 2.0+ skill for building customer support systems with PostgreSQL. Covers models, relationships, async operations, query optimization, testing, and migrations.

### What's Included

**Complete Model Patterns**:
- Customer support entities (Tickets, Users, Comments, Attachments, Tags)
- Relationship patterns (one-to-many, many-to-many, self-referential)
- Enums, soft deletes, audit trails, timestamps
...
**Query Optimization**:
- Eager loading (joinedload, selectinload) to prevent N+1 queries
- Complex filters with dynamic conditions
- Aggregations, analytics, and reporting queries
...
- Testing eager loading and performance
